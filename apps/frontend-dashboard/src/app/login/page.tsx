          ...
          <div className="card p-8 backdrop-blur-xl bg-[var(--card-bg)] border border-[var(--border)] shadow-xl">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember"
                  className="ml-2 text-sm text-[var(--foreground-muted)]"
                >
              ...
              <button 
                type="submit" 
                className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-primary-600 to-primary-500 text-white font-medium shadow-lg shadow-primary-500/30 hover:shadow-primary-500/40 transition-all hover:-translate-y-0.5 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
                  <>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[var(--card-bg)] text-[var(--foreground-muted)]">
                  Or continue with
                </span>
              </div>
            </div>
